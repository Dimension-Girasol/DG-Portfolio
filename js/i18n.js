(function () {
  ...
  const resources = {
    es: {
      ...
      "document.title.contact": "Contacto - Dimension Girasol",

      "hero.title": "Arte digital convertido en realidad",
      "hero.tag": "Impresion 3D - Figuras - Miniaturas - Grabado Laser",
      "hero.text": "Especialistas en impresion 3D en resina y filamento, pintura de miniaturas y grabado laser.",
      ...
      "how.step1.text": "Ponte en contacto con nosotros y cuentanos tu idea junto las referencias, tamano y acabado deseado.",
      "how.step2.title": "Propuesta y presupuesto",
      "how.step2.text": "Materiales, tiempos y precio claros antes de empezar.",
      "how.step3.title": "Preparacion y produccion",
      "how.step3.text": "Laminamos los archivos y los pasamos a la impresion 3D o laser con control de calidad en cada fase.",
      ...
      "how.step5.text": "Fotos finales y coordinacion de entrega o envio en un cuidadoso embalaje.",

      "about.tag": "Conocenos",
      "about.title": "Somos Dimension Girasol",
      ...
      "about.socialLabel": "Redes sociales de Dimension Girasol",
      "about.whatsapp": "Hablemos de tu idea",

      "contact.tag": "Contactanos",
      "contact.title": "Cuentanos tu idea",
      ...
      "contact.requestPlaceholder": "Selecciona una opcion",
      "contact.request3d": "Impresion 3D",
      "contact.requestPaint": "Pintura de figura",
      "contact.requestLaser": "Grabado laser",
      "contact.requestOther": "Otro",
      "contact.message": "Peticion",
      "contact.messagePlaceholder": "Cuanto mas detalle nos des, mejor podremos orientarte.",
      "contact.submit": "Enviar peticion",
      "contact.note": "El formulario abrira tu cliente de correo para enviar la peticion.",

      "projects.tag": "Nuestros proyectos",
      "projects.title": "Echa un vistazo a nuestra coleccion",
      ...
      "projects.empty": "Todavia no hay proyectos publicados.",
      "projects.error": "No se pudieron cargar los proyectos. Intentalo de nuevo mas tarde.",
      ...
      "footer.aboutLink": "Quienes somos",
